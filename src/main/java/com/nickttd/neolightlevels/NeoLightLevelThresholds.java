 ...
 * Purpose:
 * - Entry point for the NeoLightLevelThresholds mod, which overhauls hunger, exhaustion, and natural regeneration
 * mechanics to be
...
@Mod(
    modid = NeoLightLevelThresholds.MODID,
    version = Tags.VERSION,
    name = "NeoLightLevelThresholds",
...
public class NeoLightLevelThresholds {
    ...
    @SidedProxy(
        clientSide = "com.nickttd.neolightlevels.ClientProxy",
        serverSide = "com.nickttd.neolightlevels.CommonProxy")
